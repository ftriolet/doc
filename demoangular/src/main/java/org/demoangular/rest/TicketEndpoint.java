...
import org.demoangular.model.Ticket;
...
public class TicketEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Ticket> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT t FROM Ticket t WHERE t.id = :entityId ORDER BY t.id",
						Ticket.class);
	...
	public List<Ticket> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Ticket> findAllQuery = em.createQuery(
				"SELECT DISTINCT t FROM Ticket t ORDER BY t.id", Ticket.class);
